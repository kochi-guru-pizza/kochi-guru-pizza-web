        ...
        >
          {menuHighlights.map((item) => (
            <motion.div
              ...
              className="group bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-colors duration-300 border border-gray-100 dark:border-gray-700 p-6 gpu-fix"
            >
