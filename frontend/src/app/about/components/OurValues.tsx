        ...
        >
          {values.map((value) => (
            <motion.div
              ...
              className="group flex gap-5 bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700 p-7"
            >
              <div
